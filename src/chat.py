...
def create_assistant(name):
    ...
    vector_store = client.beta.vector_stores.create(name="La purga de los dioses")
...
def main():
    ...
    if args.command == 'recreate':
        delete_assistant("La purga de los dioses")
        create_assistant("La purga de los dioses")
...
assistant = create_assistant("La purga de los dioses")
